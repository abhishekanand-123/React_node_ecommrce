          ...
          <div className="col-md-4 stretch-card grid-margin">
            <div className="card bg-gradient-danger card-img-holder text-white">
              <div className="card-body">
                <img src="/admin-assets/images/dashboard/circle.svg" className="card-img-absolute" alt="circle" />
                ...
                <div className="table-responsive">
                  <table className="table">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <img src="/admin-assets/images/faces/face1.jpg" className="me-2" alt="face" /> David Grey
                        </td>
                      ...
                      <tr>
                        <td>
                          <img src="/admin-assets/images/faces/face1.jpg" className="me-2" alt="face" /> Stella Johnson
                        </td>
                      ...
                      <tr>
                        <td>
                          <img src="/admin-assets/images/faces/face1.jpg" className="me-2" alt="face" /> Marina Michel
                        </td>
                      ...
                      <tr>
                        <td>
                          <img src="/admin-assets/images/faces/face1.jpg" className="me-2" alt="face" /> John Doe
                        </td>
